  ...
  <form method="post" action="post.php" >
    ...
    <div class="form-group input-group">
      <div class="input-group-prepend">
        ...
        <input class="form-control" id="repeat-password" placeholder="Repeat password" type="password">
    </div> <!-- form-group// -->                                      
    <div class="form-group">
        <button type="submit" class="btn btn-primary btn-block"> Create Account  </button>
    </div> <!-- form-group// -->      
    <p class="text-center">Forget the Password? <a href="login.php">Log In</a> </p>                                                                 
</form>
</article>
</div> <!-- card.// -->
