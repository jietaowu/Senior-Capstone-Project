      ...
      ?>
		...
		<div class="container">
			<div class="row">
				...
				$order_quantity = $_POST['product_quantity'];

				$sql = 'INSERT INTO `order`( `user_id`, `product_id`, `order_quantity`) VALUES (:user_id,:skuid,:order_quantity)';
           ...
           <div class="container">
			<div class="row mt-5">
				<div class="alert alert-success mx-auto w-75 p-3" role="alert">
					...
					<p>You have added to the cart successfully.</p>
					<hr>
					<p class="mb-0">Check it on shopping cart.<a href="cart.php">Shopping Cart</a></p>
				</div>
			</div>
			';
