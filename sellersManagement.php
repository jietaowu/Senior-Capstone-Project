...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<div class="row text-center">
		...
		<a href="viewProducts.php" style="text-decoration: none;">
		    
			<div class="border pt-2" style="border: 1 px solid #aaa">	
				<img src="img/product.png" width="88px" height="66px" alt="">
			
				<h5 style="color: #111;font-size: 17px">Manage Inventory</h5>
				<h6 style="color: #555;font-size: 13px;">Show Products</h6>
			</div>
	   	</a>
		</div>
		...
		<div class="col-sm-4 mb-3">
			...
			<div class="border pt-2" style="border: 1 px solid #aaa">
				<img src="img/orders.png" width="88px" height="66px" alt="">
			
				<h5 style="color: #111;font-size: 17px">Buyers Orders</h5>
				<h6 style="color: #555;font-size: 13px;">Show Orders</h6>
			</div>
			</a>
