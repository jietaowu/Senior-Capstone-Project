        ...
        <div class="col-12">
          <ul class="list-group">
            ...
            <li class="list-group-item">
             ...
             <!--  <li class="list-group-item">
                <p>Mobile phone number:+12487973009</p>
                <p class="text-right"><button type="button" class="btn btn-warning">Edit</button></p>
              </li> -->
              <li class="list-group-item"><p>Password:********</p><p class="text-right"><button type="button" class="btn btn-warning"><a href="changePassword.php">Edit</a></button></p></li>
            </ul>
