    ...
    <div class="container">
      <div class="row justify-content-md-center text-center m-4">
        ...
        <div class="table-responsive">
          <p class="text-right"><a href="addProducts.php"><i class="fas fa-plus"></i></a></p>
...
while($row = mysqli_fetch_assoc($query)){
 ...
 ?>
              ...
              <tr>
              	...
              	<td><img src="image/<?php echo $row['product_image']; ?>" alt="" class="img-responsive" width="60px" height="60px"></td>
                <td><?php echo $row['product_id']; ?></td>
                <td><?php echo $row['product_name'];  ?></td>
                <td><?php echo $row['product_price'];  ?></td>
                <td><?php echo $row['product_quantity']; ?></td>
                <td><a href="editProducts.php?skuid=<?php echo $row['product_id']; ?>"><i class="fas fa-edit"></i></a><a href="deleteProducts.php?skuid=<?php echo $row['product_id']; ?>"><i class="fas fa-trash-alt"></i></a></td>
