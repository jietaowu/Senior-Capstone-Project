...
$conn = mysqli_connect('localhost','root','root','ou_ecommerce');
...
<div class="container">
    <div class="row justify-content-md-center text-center m-4">
        ...
        <form action="addEthWallet.php" method="post" enctype="multipart/form-data">
            <div class="row mb-2 item">
                <span class="goodslaber">Please input your address:</span>
            </div>
            <div class="row mb-2 item">
                <input type="text" name="eth_address" placeholder="please enter your eth wallet address" id="address">
            </div>
            <div class="row mb-2">
